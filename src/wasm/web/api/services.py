...
async def get_service(name: str, request: Request, session: dict = Depends(get_current_session)):
    """
...
async def start_service(name: str, request: Request, session: dict = Depends(get_current_session)):
    """
    Start a service.
    """
    from wasm.managers.service_manager import ServiceManager
    ...
    try:
        ...
        return ServiceActionResponse(success=True, message=f"Service started: {name}", service=name)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))


@router.post("/{name}/stop", response_model=ServiceActionResponse)
async def stop_service(name: str, request: Request, session: dict = Depends(get_current_session)):
    """
    Stop a service.
    """
    from wasm.managers.service_manager import ServiceManager
    ...
    try:
        ...
        return ServiceActionResponse(success=True, message=f"Service stopped: {name}", service=name)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def restart_service(
    ...
    try:
        ...
        return ServiceActionResponse(
            success=True, message=f"Service restarted: {name}", service=name
        )
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def enable_service(name: str, request: Request, session: dict = Depends(get_current_session)):
    """
    ...
    try:
        ...
        return ServiceActionResponse(success=True, message=f"Service enabled: {name}", service=name)
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def disable_service(
    ...
    try:
        ...
        return ServiceActionResponse(
            success=True, message=f"Service disabled: {name}", service=name
        )
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_service_logs(
    ...
    return {"service": name, "logs": logs, "lines": lines}
...
async def delete_service(name: str, request: Request, session: dict = Depends(get_current_session)):
    """
