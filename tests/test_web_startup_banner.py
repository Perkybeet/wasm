...
Ported verbatim from tests/test_web_banner.py: ``startup_banner`` is printed
on the operator's terminal by the CLI, not part of the deleted Jinja UI, so
it survives the cut-over to the React SPA untouched.
