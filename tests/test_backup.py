...
class TestBackupCLIHandlers:
    ...
    def test_backup_list_empty(self, mock_manager_cls):
        ...
        args = Namespace(domain=None, tags=None, limit=None, json=False, verbose=False)
    ...
    def test_backup_list_json_output(self, mock_manager_cls, capsys):
        ...
        args = Namespace(domain="test.com", tags=None, limit=None, json=True, verbose=False)
        result = _backup_list(args, verbose=False)
...
class TestBackupIntegration:
    ...
    def test_rollback_flow(self, mock_rollback_cls):
        ...
        args = Namespace(domain="test.com", backup_id=None, no_rebuild=False, verbose=False)
